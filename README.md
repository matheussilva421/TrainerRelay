...
2. Download the locally produced **`TrainerRelay.zip`** artifact. A GitHub release/tag for `v0.1.0-experimental.24` will be published only after the physical Steam Deck gate passes.
