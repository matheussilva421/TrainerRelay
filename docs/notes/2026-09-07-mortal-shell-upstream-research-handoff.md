...
GitHub em preparação final: publicar somente os cinco documentos listados; não empacotar o working tree. Nenhum arquivo de implementação foi parcialmente editado nesta pesquisa; implementação preexistente permanece intacta. Reversão documental futura: reverter apenas o commit desta pesquisa.
